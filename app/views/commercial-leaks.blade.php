			...
			<div class="row">
				<div class="col-xs-10 col-sm-6 col-md-6 col-xs-offset-1 col-sm-offset-0 col-md-offset-0">
					<div class="banner-form">
						<div class="form-title"><h2>Commercial Leak Repairs starting at $350!</h2></div>
						<!-- Contact Form -->
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 headline">
				...
				<p>Our licensed and insured staff is ready to assist you with your commercial roof repair needs. Whether you want to give your business a new look, prevent on-going water damage, or need repairs after a storm, we’re ready to help!</p>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-6 hidden-xs"><img src="img/image-three.jpg" class="img-responsive" alt="Maxsus Installing Roll Roofing for an Atlanta Client" title="Maxsus Installing Roll Roofing for an Atlanta Client"></div>
			<div class="col-sm-6">
				<div class="features">
					<i class="line-font blue icon-check"></i><h3>Customer Oriented</h3>
					<p>We are here to provide unsurpassed customer service. Our staff will offer personalized roof and leak repair options picked so you can make the best decision for your business.</p>
				</div>
				<div class="features">
					<i class="line-font blue icon-drop"></i><h3>Professional Leak Repairs</h3>
					<p>Damaged roll roofing, poorly installed waterproofing and storm damage to your roof can cause damage to your business and delay day-to-day operations. Maxsus guarantees their roof repairs will prevent further water damage and help keep your business operating at 100%.</p>
				</div>
				<div class="features">
					<i class="line-font blue icon-home"></i><h3>Local, Dependable, and Well Reviewed</h3>
					<p>Backed by a 5 year workmanship warranty, Maxsus will help you find peace of mind knowing that your business is in good hands. We have helped plenty of businesses in your area; see what others are saying about the Maxsus Difference. </p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<p>Luke attributes much of his success to an unparalleled standard of quality. Ensuring each home owner is delighted with their their results has certainly paid off: from these humble beginnings Luke has expanded Maxsus to help restore thousands of Georgia homes and businesses without losing remarkable quality service that made Maxsus stand out.</p>
			</div>
		...
		<hr class="separator60">
		<div class="row">
			<div class="col-sm-6 hidden-xs"><img src="img/image-four.jpeg" class="img-responsive" alt="Maxsus Roofing and Restoration is based in Atlanta, GA" title="Maxsus Roofing and Restoration is based in Atlanta, GA"></div>
			<div class="col-sm-6">
				<div class="margintop">
					<h2>Quality Craftsmanship Guaranteed</h2>
					<p>Maxsus is a Roofing &amp; Restoration company that has been built from the ground up with the specific intention of becoming the best in the industry at mitigating storm damage and stopping those annoying roof leaks that seem to keep coming back. Picking a certified, experienced contractor can save you thousands, which is why we always hold our work to the highest standard. Our specialists stay well informed on commercial roof repair and installation best practices, including:</p>
...
<section id="savings" class="section bg-blue-pattern white-text">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<!-- Deals and Savings Header -->
				<div class="headline"><h2>Deals &amp; Savings</h2><p>Take a look at some of the great benefits we offer.</p>
				</div>
			</div>
		</div>
		<div class="row text-center">
			<div class="col-md-4">
				<div class="main-point">
					<i class="line-font icon-target"></i><h3>Complimentary Surveys</h3>
					<p>Large building restorations require a well thought out plan of action. We'll include a copy of our satellite home-survey with each project so we can keep you informedevery step of the way.</p>
				</div>
			</div>
			<div class="col-md-4">
				<div class="main-point">
					<i class="line-font icon-like"></i><h3>Satisfactory Review Discount</h3>
			...
			<div class="col-md-4">
				<div class="main-point">
					<i class="line-font icon-bubbles"></i><h3>Business Referral Program</h3>
					<p>We love that most of our business comes from referrals, and we want to show you our apprecition. Businesses who qualify can receive up to $500 in rebates!</p>
				</div>
			</div>
		</div>
	</div>
