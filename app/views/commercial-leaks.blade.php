...
<script>function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');
  ...
  ga('create', 'UA-51222414-11', 'auto');
  ga('send', 'pageview');

</script>
<!-- End Google Analytics Pageview -->
			...
			<div class="row">
				...
				<div class="banner-form">
					<div class="form-title">
						<h2>Commercial Leak Repairs starting at $350!</h2>
					</div>
				...
				<div class="col-xs-10 col-sm-6 col-md-6 col-xs-offset-1 col-sm-offset-0 col-md-offset-0">
					...
					@include('layouts.partials._form-commercial')
...
<div id="clients" class="padding40 bg-grey">
	<div class="container">
		<ul class="list-inline clients-logo text-center">
			<li class="margin20"><img src="img/residential/certainteed.png" alt="" title="" /></li>
			<li class="margin20"><img src="img/residential/eagle-logo.png" alt="" title="" /></li>
			<li class="margin20"><a href="http://www.angieslist.com/companylist/us/ga/buford/maxsus-inc-roofing-and-restoration-reviews-2313508.htm" target="_blank"><img src="img/residential/angies-logo.png" alt="" title="" /></a></li>
			<li class="margin20"><img src="img/residential/logo-gaf-elk.png" alt="" title="" /></li>
			<li class="margin20"><img src="img/residential/certainteed-logo.png" alt="" title="" /></li>
		</ul>
	</div>
</div>
<!-- End Clients Logo -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 headline">
					...
					<p>Our licensed and insured staff is ready to assist you with your commercial roof repair needs. 
					Whether you want to give your business a new look, prevent on-going water damage, or need repairs after a storm, 
					we’re ready to help!</p>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6 hidden-xs">
					<img src="img/image-three.jpg" class="img-responsive" alt="" title="">
				</div>
				<div class="col-sm-6">
					<div class="features"><!-- Main Points -->
						<i class="line-font blue icon-check"></i><!-- Main Point Icon -->
						<h3>Customer Oriented</h3><!-- Main Title -->
						<p>We are here to provide unsurpassed customer service. Our staff will offer personalized roof and leak repair options picked so you can
						make the best decision for your business.</p><!-- Main Text -->
					</div><!-- End Main Points -->
					<div class="features">
						<i class="line-font blue icon-drop"></i>
						<h3>Professional Leak Repairs</h3>
						<p>Damaged roll roofing, poorly installed waterproofing and storm damage to your roof can cause damage to your business and delay day-to-day operations. 
						Maxsus guarantees their roof repairs will prevent further water damage and help keep your business operating at 100%. 
						</p>
					</div>
					<div class="features">
						<i class="line-font blue icon-home"></i>
						<h3>Local, Dependable, and Well Reviewed</h3>
						<p>Backed by a 5 year workmanship warranty, Maxsus will help you find peace of mind knowing that your business is in good hands. We have helped plenty of
						businesses in your area; see what others are saying about the Maxsus Difference. </p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-6">
					...
					Whole Foods where he would host a daily production meeting and buy everybody coffee &amp; breakfast to get the day started. 
					Within a few months he earned enough to move the crew into the first location and get a few work trucks. A couple of 
					years later, Maxsus is providing roofing &amp; restoration services across several cities throughout the southeast.</p>
					...
					their results has certainly paid off: from these humble beginnings Luke has expanded Maxsus to help restore thousands of Georgia
					homes and businesses without losing remarkable quality service that made Maxsus stand out.</p>
				</div>
				<div class="col-sm-6">
			...
			<div class="row">
				<div class="col-sm-6 hidden-xs">
					<img src="img/image-four.jpeg" class="img-responsive" alt="" title="">
				</div>
				<div class="col-sm-6">
					<div class="margintop">
						<h2>Quality Craftsmanship Guaranteed</h2>
						<p>Maxsus is a Roofing &amp; Restoration company that has been built from the ground up with the specific intention of 
						becoming the best in the industry at mitigating storm damage and stopping those annoying roof leaks that seem to keep coming back. 
						Picking a certified, experienced contractor
						can save you thousands, which is why we always hold our work to the highest standard. Our specialists stay well informed on commercial
						roof repair and installation best practices, including:
						<ul class="green-arrow"><!--Green arrow list -->
							<li>New Roof Design, Weatherization, and Waterproofing</li>
							<li>Roof Evaluation, Budget Estimation and Roof Replacement</li>
							<li>Green Roof Consulting and Commercial Construction</li>
							<li>Emergy Roof Damage Mitigation, Roof Maintenance Planning and Energy Efficiency Analysis</li>
						</ul>
						<p>No project is too big or too small to guarantee a job well done; Maxsus is happy to assist with commercial leak repairs of all sizes.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="headline">
						<h2>Deals &amp; Savings</h2>
						<p>Take a look at some of the great benefits we offer.</p>
					</div>
				</div>
			</div>
			<div class="row text-center">
				<div class="col-md-4">
					<div class="main-point"><!-- Main Point -->
						...
						<p>Large building restorations require a well thought out plan of action. We'll include a copy of our satellite home-survey with each project so we can keep you informed
				...
				<div class="col-md-4">
					<div class="main-point">
						...
						<p>We love that most of our business comes from referrals, and we want to show you our apprecition. Businesses who qualify can receive up to 
						$500 in rebates!</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="headline">
						<h2>Testimonials</h2>
						<p>See what others are saying about Maxsus</p>
					</div>
				</div>
			</div>	
			<div class="row">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="headline">
						...
						<p>If a storm has damaged your roof, liability insurance may replace them at no cost to you! You'll definitely have questions, and we will
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center white-text">
					<div class="headline">
						<h2>Satisfied with the introduction ?</h2>
						<p class="subline">Fill out our contact form to schedule a free analysis!</p>
					</div>
