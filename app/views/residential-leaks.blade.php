			...
			<div class="row">
				...
				<div class="banner-form">
					<div class="form-title">
						<h2>Home Roof Leak Repairs starting at $250!</h2>
					</div>
...
<div id="clients" class="padding40 bg-grey">
	<div class="container">
		<ul class="list-inline clients-logo text-center">
			<li class="margin20"><img src="img/residential/certainteed.png" alt="" title="" /></li><!--Image path of logo -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 headline">
					...
					<p>Our licensed and insured staff is ready to assist you with your home roof repair needs. 
					Whether you want to give your home a new look, prevent on-going water damage, or need repairs after a storm, 
			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="features">
						...
						<p>Damaged shingles, poorly installed ridge vents and storm damage to your roof can cause damage to your home and property. Maxsus guarantees their 
						roof repairs will prevent further water damage and help keep your home looking beautiful. 
						</p>
					</div>
					<div class="features">
						<i class="line-font blue icon-home"></i>
						<h3>Local, Dependable, and Well Reviewed</h3>
						<p>Backed by a 5 year workmanship warranty, Maxsus will help you find peace of mind knowing that your home is in good hands. We have helped plenty of
			...
			<div class="row">
				<div class="col-sm-6">
					...
					homes without losing remarkable quality service that made Maxsus stand out.</p>
				</div>
				<div class="col-sm-6">
			...
			<div class="row">
				<div class="col-sm-6 hidden-xs">
					<img src="img/residential/image-two.jpg" class="img-responsive" alt="" title="">
				</div>
				<div class="col-sm-6">
					<div class="margintop">
			...
			<div class="row text-center">
				<div class="col-md-4">
					<div class="main-point"><!-- Main Point -->
						...
						<p>Large home restorations require a well thought out plan of action. We'll include a copy of our satellite home-survey with each project so we can keep you informed
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="headline">
						...
						<p>If a storm has damaged your roof, homeowner's insurance may replace them at no cost to you! You'll definitely have questions, and we will
